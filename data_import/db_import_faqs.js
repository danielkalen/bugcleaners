var insertFaqs = function(Faqs, FaqCategories){
	var faqs = [
					{
					...
					{
						'categories': ['Termites', 'Prevention'],
					...
					{
						'categories': ['Safety', 'General', 'Treatment'],
	...
	faqCategories.forEach(function(value, index, parentArray){
		FaqCategories.insert(value);
	});
};

module.exports = insertFaqs;