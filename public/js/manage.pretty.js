...
(function($) {
  ...
  if (isPageManagement) {
    ...
    Variation.prototype.clone = function() {
      ...
      return subnotify('info', "Variation was successfuly cloned. Don't forget that images aren't cloned over and to save it in order to apply the changes to the database", 5000);
    };
          ...
          DB.post.insert({
            ...
            'cb': (function(_this) {
              return function(res) {
                var ref, state;
                if (res.success) {
                  subnotify('success', _this.single + " \"" + _this.name + "\" was successfuly inserted!");
          ...
          return DB.post.update({
            ...
            'cb': (function(_this) {
              return function(res) {
                ...
                state = res.success ? 'save_success' : 'save_error';
                if (res.success) {
                  subnotify('success', _this.single + " \"" + _this.name + "\" was successfuly updated!");
                }
                _this.statusField.html(res.message);
                _this.el.removeClass('sending').addClass(state);
                return setTimeout(function() {
